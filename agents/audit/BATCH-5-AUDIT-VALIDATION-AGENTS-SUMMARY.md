...
**File**: `agents/audit/code-audit/code-audit-specialist.md`
...
**File**: `agents/audit/compliance/compliance-validation-agent.md`
...
**File**: `agents/audit/production-readiness/production-readiness-checker.md`
...
**File**: `agents/audit/quality-gates/quality-gate-enforcer.md`
...
**File**: `agents/audit/technical-debt/technical-debt-auditor.md`
